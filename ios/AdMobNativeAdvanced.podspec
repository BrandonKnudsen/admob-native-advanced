Pod::Spec.new do |spec|
  ...
  spec.license = 'MIT'
  spec.homepage = 'https://github.com/capacitor-community/admob-native-advanced'
  spec.author = 'Capacitor Community'
  spec.source = { :git => 'https://github.com/capacitor-community/admob-native-advanced.git', :tag => spec.version.to_s }
